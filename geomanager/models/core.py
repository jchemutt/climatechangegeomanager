...
class Dataset(TimeStampedModel, AdminSortable):
    ...
    metadata_properties = models.JSONField(
    blank=True,
    null=True,
    verbose_name=_("metadata properties"),
    help_text=_("Custom metadata like variable, scenario, time_period, model, calculation")
    )
    ...
    panels = [
        ...
        FieldPanel("summary"),
        FieldPanel("metadata"),
        FieldPanel("metadata_properties"), 
